class BankAndIdentityDetail < ActiveRecord::Base
  belongs_to :user
  validates :account_no, :bank_name ,:branch_name ,:city ,:ifsc_code ,:pancard_no ,presence: true
  validates :account_no, :numericality => true, length: {minimum:8 ,maximum: 16}, uniqueness: true
